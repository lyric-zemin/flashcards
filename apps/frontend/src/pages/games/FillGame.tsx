...
const FillGame: React.FC = () => {
  ...
  const defaultGameData = [
    { character: '人', pinyin: 'rén', image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=cute%20cartoon%20person%20for%20children&image_size=portrait_4_3', meaning: 'person' },
    { character: '口', pinyin: 'kǒu', image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=cute%20cartoon%20mouth%20for%20children&image_size=portrait_4_3', meaning: 'mouth' },
    { character: '日', pinyin: 'rì', image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=cute%20cartoon%20sun%20for%20children&image_size=portrait_4_3', meaning: 'sun' },
    { character: '月', pinyin: 'yuè', image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=cute%20cartoon%20moon%20for%20children&image_size=portrait_4_3', meaning: 'moon' },
    { character: '水', pinyin: 'shuǐ', image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=cute%20cartoon%20water%20for%20children&image_size=portrait_4_3', meaning: 'water' },
    { character: '火', pinyin: 'huǒ', image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=cute%20cartoon%20fire%20for%20children&image_size=portrait_4_3', meaning: 'fire' },
    { character: '山', pinyin: 'shān', image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=cute%20cartoon%20mountain%20for%20children&image_size=portrait_4_3', meaning: 'mountain' },
    { character: '石', pinyin: 'shí', image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=cute%20cartoon%20stone%20for%20children&image_size=portrait_4_3', meaning: 'stone' },
    { character: '木', pinyin: 'mù', image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=cute%20cartoon%20tree%20for%20children&image_size=portrait_4_3', meaning: 'wood' },
    { character: '金', pinyin: 'jīn', image: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=cute%20cartoon%20gold%20for%20children&image_size=portrait_4_3', meaning: 'gold' }
  ]
